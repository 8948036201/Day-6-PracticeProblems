...
#Make Function for checking Palindrome
...
#Make Function for checking the number is prime or not
function isPrime() {
...
#Taking a user input variable choice
read -p "Please select choice 1)Prime check 2)Check pallindrome 3) check pallindrom is prime :" choice

#Switch cases for choosing  any one of the taking input variable which we want to check
case $choice in
